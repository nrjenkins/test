...
\entry{Spring 2020 -- Present}
			...
			{\ucr}
			{I was hired by the School of Public Policy as a quantitate methods consultant for Master of Public Policy students' capstone projects.}
...
\section{Conference Participation and Workshops}
...
\entry{\textit{In Progress}}
			...
			{I am working on a series of tutorials that teach users how to program Bayesian models in Stan and how to use R for a Bayesian workflow.}
