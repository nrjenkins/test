...
\entry{Fall 2020}
			...
			{\ucr}
			{Created and taught a 6-week workshop for the Master of Public Policy program to introduce the graduate students the basics of data science using Stata and R.}
