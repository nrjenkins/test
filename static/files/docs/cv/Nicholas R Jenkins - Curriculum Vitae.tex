...
\newcommand{\website}{\includegraphics[align=c, height=1\baselineskip]{website.png}}
...
\entry{\emph{In Progress}}
			...
			{\ucr}
			{Dissertation Committee: Kevin Esterling (Chair), \href{https://sites.google.com/site/melindaritchie/}{Melinda Ritchie}, \href{https://sites.google.com/view/nicholas-weller}{Nick Weller}, and \href{http://www.indridason.politicaldata.org}{Indridi Indridason}}
...
\entry{Spring 2020 -- Present}
			{Master of Public Policy Capstone Project Quantitative Consultant}
			{\ucr}
			{I work for the School of Public Policy as mentor to Master of Public Policy students on quantitate capstone projects.}
...
\textbf{\textsc{Refereed Journal Articles}}

\begin{etaremune}
	\item \pub{\fullcite{jenkins2020}}{}{}
	\item \pub{\fullcite{meyer2019}}{}{}
\end{etaremune}

\textbf{\textsc{Manuscripts Under Review}}

\begin{enumerate}
	\item \pub{\fullcite{jenkinsa}}{}{}
\end{enumerate}

\textbf{\textsc{Manuscripts in Preparation}}

\begin{enumerate}
	\item \pub{\fullcite{jenkinsc}}{}{}
	\item \pub{\fullcite{jenkinsb}}{}{}
	\item \pub{\fullcite{jenkinse}}{}{}
\end{enumerate}
...
%\textbf{\textsc{Conferences Organized}}


%\textbf{\textsc{Panels Organized}}



\textbf{\textsc{Papers Presented}}

\bigskip

%\entry{2021}
%			{Paying-to-Play: How Members of Congress Purchase Their Seat At the Table}
%			{Presented at the Midwestern Political Science Association Annual Meeting}
%			{}

%\entry{2021}
%			{Committee Assignments Here! How Members of Congress Buy Their Committee Seats}
...
%\textbf{\textsc{Discussant}}

%In addition to these presentations and workshops, be sure to look through the tutorials that I've written for my website here: \href{https://nicholasrjenkins.science/tutorial/}{https://nicholasrjenkins.science/tutorial}.
...
\entry{2020}
			...
			{\ucr}
			{Presented on how to use active learning techniques in the classroom during the \href{https://gsrc.ucr.edu/aftergrad/tcw}{Teaching Development Day}.}
...
\textbf{\textsc{Workshops Taught}}

\bigskip

\entry{Fall 2020}
			{Data Science using Stata and R \href{https://github.com/nrjenkins/Data-Science-Workshop}{\gh}}
			{\ucr}
			{Created and taught a 6-week workshop for the Master of Public Policy program to introduce the graduate students to the basics of data science using Stata and R.}
...
\entry{Spring 2020}
			{Theory and Methodology of Political Science (Online)}
			{\ucr}
...
\entry{Winter 2020}
			...
			\begin{description}
				\item Section 1: \href{https://nrjenkins.github.io/nrjenkins.github.io/files/docs/teaching_evals/PBPL220_Winter20_Scores.pdf}{Median Rating: 7.00/7.00, Mean Rating: 6.84/7.00}, \href{https://nrjenkins.github.io/nrjenkins.github.io/files/docs/teaching_evals/PBPL220_Winter20_Comments.pdf}{Student Feedback}.
...
\entry{Spring 2017 Fall 2016 Spring 2016 Fall 2015}
			...
			\begin{description}
				\item \underline{Spring 2017 Evaluations:}
				...
				\item \underline{Fall 2016 Evaluations:}
				...
				\item \underline{Spring 2016 Evaluations:}
				...
				\item \underline{Fall 2015 Evaluations:}
...
\entry{\textit{In Progress}}
			{Bayesian Inference Using R and Stan \href{https://nicholasrjenkins.science/tutorial/bayesian-inference-with-stan/}{\website}}
			{\href{https://nicholasrjenkins.science/tutorial/bayesian-inference-with-stan/}{https://nicholasrjenkins.science/tutorial/bayesian-inference-with-stan/}}
			{I am working on a series of tutorials that teach users how to program Bayesian models in Stan and use R for a Bayesian workflow.}
