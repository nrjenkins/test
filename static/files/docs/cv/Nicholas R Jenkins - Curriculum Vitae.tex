...
\entry{2020}
			...
			{Presented at the Association for Public Policy Analysis \& Management Regional Student Conference, Riverside, CA}
			{}
...
\entry{2020}
			...
			{\ucr}
			{The Diversity Certificate Program is a one-quarter long program that considers broad issues that affect higher and postsecondary education, as well as the depth of knowledge and experience gained across a variety of learning contexts. The various experiences, backgrounds, and attributes of learners have a significant impact on their engagement with learning, perceptions of campus climate, and their educational and social outcomes. Learner differences cross dimensions that are material, corporeal, and symbolic. Together, we will explore intersectional strategies for negotiating these differences in: 
			\begin{itemize} 
